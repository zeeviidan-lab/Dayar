  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-4 z-40 bg-white border border-[#ccc] text-[#555] text-xs px-3 py-2 rounded-full shadow-md hover:border-[#f97316] hover:text-[#f97316] transition-colors"
      >
        💬 פידבק
      </button>
