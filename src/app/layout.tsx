...
export const metadata: Metadata = {
  ...
  description: "לפני השכרת דירה — בדקו את הדירה והמשכיר: ביקורות אמיתיות ואנונימיות של שוכרים על דירות להשכרה ומשכירים בכל הארץ, בחינם.",
  keywords: ["ביקורות דיירים", "ביקורות על משכיר", "לבדוק משכיר", "השכרת דירות", "השכרת דירה", "דירות להשכרה", "שכירות", "דירה", "משכיר", "הדייר", "דייר", "hadayar", "ישראל"],
  openGraph: {
    siteName: "דַּיָּר",
    locale: "he_IL",
    type: "website",
